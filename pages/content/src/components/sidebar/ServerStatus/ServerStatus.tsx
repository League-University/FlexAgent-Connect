            ...
            <CardContent className="p-4 text-xs text-slate-700 dark:text-slate-300">
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                  <div className="mb-2">
                    <strong>To start FlexAgent Connect Proxy:</strong>
                  </div>
                  <div className="bg-slate-100 dark:bg-slate-800 p-2 rounded font-mono text-xs border">
                    npx flexagent-connect-proxy@latest --config ./config.json --outputTransport {connectionType === 'sse' ? 'sse' : connectionType === 'websocket' ? 'ws' : 'streamableHttp'}
                  </div>
